...
//  Quizzler
//
//  Created by Jasneet Singh on 2/6/19.
...
class QuestionBank {
    ...
    var list = [Question]()
    //Calling Question Class
    
    init() {
        //Questions and Answers for list array
        // Creating a quiz item and appending it to the list
        let item = Question(text: "Valentine\'s day is banned in Saudi Arabia.", correctAnswer: true)
        //Question - references question class and looks to see how to process rest of info.
